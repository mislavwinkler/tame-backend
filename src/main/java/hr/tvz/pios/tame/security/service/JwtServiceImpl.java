...
import hr.tvz.pios.tame.security.domain.Authority;
import hr.tvz.pios.tame.security.domain.User;
import hr.tvz.pios.tame.security.user.ApplicationUser;
import hr.tvz.pios.tame.security.user.UserAuthentication;
